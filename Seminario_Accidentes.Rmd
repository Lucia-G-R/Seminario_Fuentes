...
### **Carga de datos JSON**
Queremos extraer los datos sobre las enfermedades laborales que suceden en España, como es un archivo con extensión .JSON con listas anidadas sin etiquetar.
```{r}
library(rjson)
library(tidyverse)
library(tidyjson)
...
# Convertir la lista JSON en un data frame
españa_df <- españa %>%
  as_tibble() %>%
  spread_all() 
