...
canarias_when <- 
  ...
  mutate(Categoria = case_when(
    ...
    Sexo == "Mujeres" & Obs > 5000 ~ "Accidentes Mujeres - Alto",
    Sexo == "Hombres" & Obs > 5000 ~ "Accidentes Hombres - Alto",
    
    Sexo == "Mujeres" & Obs <= 5000 ~ "Accidentes Mujeres - Bajo",
    Sexo == "Hombres" & Obs <= 5000 ~ "Accidentes Hombres - Bajo",
