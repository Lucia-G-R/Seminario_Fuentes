...
```{r}
# Librerías necesarias para JSON 


# Librerías y paquetes necesarias para xls
install.packages("readxl")
library(readxl)

# Librerías y paquetes necesarias para csv
install.packages("readr")
library(readr)

# Librerías necesarias para xlsx
install.packages("readxl")
library(readxl)
```
...
españa <- fromJSON("INPUT/DATA/Enfermedades_laborales_España.json", flatten = TRUE)
...
# Convertimos la lista JSON en un data frame
#españa_df <- españa %>%
  #as_tbl_json() %>%    # Manejamos las estructuras anidadas
  #enter_object() %>%   # Entra a los niveles de los objetos dentro del JSON
  #gather_array() %>%   # Convierte listas en un formato tabular
  #spread_all()         # Expande todas las columnas al formato tabular
