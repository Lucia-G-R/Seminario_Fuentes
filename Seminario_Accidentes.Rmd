...
# **Metodología**
## **Materiales**
Agregamos los URL de la base de datos `datos.gob.es` donde obtenemos los datos para el posterior estudio:
...
Como es un archivo con extensión .JSON con listas anidadas sin etiquetar, no podemos utilizar directamente un tibble para ello, utilizaremos tidyjson.
