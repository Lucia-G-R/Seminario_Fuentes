...
### **Eliminar columnas**
Eliminamos las columnas que no nos van a interesar estudiar, es decir, seleccionaremos las columnas que nos interesan. 
...
Primero vamos a eliminar las columnas del conjunto de datos sobre los trabajos realizados en Canarias. Nos vamos a quedar solo con las columnas Año, Sexo, Gravedad, TipoTrab y Obs.
```{r, warning=FALSE} 
