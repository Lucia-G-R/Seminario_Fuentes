...
### **Arrange**
Ordenamos las filas de manera descendente según los niveles de gravedad de los accidentes en el conjunto de datos de Aragón. Mediante la función arrange.
```{r, warning=FALSE}
library("DT")
