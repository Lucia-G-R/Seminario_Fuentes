---
title: "Desarrollo de distintas enfermedades según el oficio" <img src='images/imagen.png' align="right" height="120" />
...
Como al imprimirlo en formato tabla con la función datatable nos da un error con el formato, es decir, indica que hay un problema con la codificación del archivo CSV. En este caso, el error me indica que los archivos están codificados en UTF-8, pero revisando la tabla incluye caracteres como acentos.
```{r, warning=FALSE}
...
# Unimos por una columna diferente en canarias estará la columna Obs y en Espana estará la columna Valor
df_cana_Esp <- merge(canarias, Espana, by.x = "Obs", by.y = "Valor")
...
https://stackoverflow.com/search?q=input+string+1+is+invalid+UTF-8

url articulos
https://www.who.int/es/news-room/fact-sheets/detail/mental-disorders
https://www.redalyc.org/journal/170/17049838011/html/#:~:text=Fundamentos%3A%20Seg%C3%BAn%20las%20estad%C3%ADsticas%20oficiales,participaci%C3%B3n%20en%20el%20mundo%20laboral.
